    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-4 my-16 md:mx-10'>
        ...
        <div className='w-full grid grid-cols-auto gap-4 pt-5 gap-y-6 px-3 sm:px-0'>
          ...
          <div onClick={() => navigate(`/appointments/${item.id}`)} key={index} className='border border-blue-200 rounded-xl overflow-hidden cursor-pointer hover:translate-y-[-10px] transition-all duration-500'>
