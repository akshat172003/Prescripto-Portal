...
const AddDoctor = () => {
    ...
    const onSubmitHandler= async (event)=>{
        ...
        try {
            ...
            formData.append('address',JSON.stringify({line1:address1,line2:address2,city:address3}))

            //consolr log formdata
  ...
  return (
    <form className='m-5 w-full' onSubmit={onSubmitHandler}>
      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
            ...
            <div className='w-full lg:flex-1 flex flex-col gap-4'>
                ...
                <div className='flex-1 flex flex-col gap-1'>
                    ...
                    <input onChange={(e)=>setAddress3(e.target.value)} value={address3} className='border rounded px-3 py-2 ' type="text" placeholder='City' required />
                </div>
            </div>
        </div>
        <div className='flex-1 flex flex-col gap-1'>
        ...
        <button type='submit' className='bg-primary text-white text-sm px-10 py-2 mt-4 rounded-full'>Add Doctor</button>
      </div>
    </form>
  )
}
